...
Version  : 5.13.2
Release  : 41
URL      : http://download.qt.io/official_releases/QtForPython/pyside2/PySide2-5.13.2-src/pyside-setup-opensource-src-5.13.2.tar.xz
Source0  : http://download.qt.io/official_releases/QtForPython/pyside2/PySide2-5.13.2-src/pyside-setup-opensource-src-5.13.2.tar.xz
...
%prep
%setup -q -n pyside-setup-opensource-src-5.13.2
cd %{_builddir}/pyside-setup-opensource-src-5.13.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576291020
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/LICENSE.FDL %{buildroot}/usr/share/package-licenses/pyside2-setup/61907422fefcd2313a9b570c31d203a6dbebd333
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/pyside2-setup/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/LICENSE.GPLv3 %{buildroot}/usr/share/package-licenses/pyside2-setup/7d974f34cf5fd474f0fdf6ebc8d410ea5c8b72de
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/LICENSE.GPLv3-EXCEPT %{buildroot}/usr/share/package-licenses/pyside2-setup/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/LICENSE.LGPLv3 %{buildroot}/usr/share/package-licenses/pyside2-setup/3e14af11ba18dbb289fda3a9f35d7519536c3594
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/patchelf/COPYING %{buildroot}/usr/share/package-licenses/pyside2-setup/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/pyside2-tools/LICENSE-lupdate %{buildroot}/usr/share/package-licenses/pyside2-setup/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/pyside2-tools/LICENSE-rcc %{buildroot}/usr/share/package-licenses/pyside2-setup/831885f4ef4eccb4965bcddee48f0de3b5aea2d1
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/pyside2-tools/LICENSE-uic %{buildroot}/usr/share/package-licenses/pyside2-setup/b53bc3fd83f7813a57d2dbf06898fc3eeb54469c
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/pyside2/COPYING %{buildroot}/usr/share/package-licenses/pyside2-setup/2d209c3df5b6b8a8549da5992e89eece382434f5
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/pyside2/PySide2/licensecomment.txt %{buildroot}/usr/share/package-licenses/pyside2-setup/36707a948d90e9430e03bd38f76c1518c666fd8a
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/pyside2/doc/codesnippets/examples/dialogs/licensewizard/licensewizard.h %{buildroot}/usr/share/package-licenses/pyside2-setup/9751352206358b0b052360705c08a011222a82e8
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/shiboken2/ApiExtractor/COPYING %{buildroot}/usr/share/package-licenses/pyside2-setup/831885f4ef4eccb4965bcddee48f0de3b5aea2d1
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/shiboken2/COPYING %{buildroot}/usr/share/package-licenses/pyside2-setup/831885f4ef4eccb4965bcddee48f0de3b5aea2d1
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/shiboken2/COPYING.libsample %{buildroot}/usr/share/package-licenses/pyside2-setup/2d209c3df5b6b8a8549da5992e89eece382434f5
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/shiboken2/COPYING.libshiboken %{buildroot}/usr/share/package-licenses/pyside2-setup/2d209c3df5b6b8a8549da5992e89eece382434f5
cp %{_builddir}/pyside-setup-opensource-src-5.13.2/sources/shiboken2/libshiboken/embed/qt_python_license.txt %{buildroot}/usr/share/package-licenses/pyside2-setup/2ef8b491360bc83acc58e2142c37c5dd7313e71d
pushd clr-build
%make_install
popd
...
/usr/lib64/cmake/PySide2-5.13.2/PySide2Config.cmake
/usr/lib64/cmake/PySide2-5.13.2/PySide2Config.cpython-38-x86_64-linux-gnu.cmake
/usr/lib64/cmake/PySide2-5.13.2/PySide2ConfigVersion.cmake
/usr/lib64/cmake/PySide2-5.13.2/PySide2Targets-relwithdebinfo.cmake
/usr/lib64/cmake/PySide2-5.13.2/PySide2Targets.cmake
/usr/lib64/cmake/Shiboken2-5.13.2/Shiboken2Config.cmake
/usr/lib64/cmake/Shiboken2-5.13.2/Shiboken2Config.cpython-38-x86_64-linux-gnu.cmake
/usr/lib64/cmake/Shiboken2-5.13.2/Shiboken2ConfigVersion.cmake
/usr/lib64/cmake/Shiboken2-5.13.2/Shiboken2Targets-relwithdebinfo.cmake
/usr/lib64/cmake/Shiboken2-5.13.2/Shiboken2Targets.cmake
/usr/lib64/cmake/Shiboken2-5.13.2/shiboken_helpers.cmake
...
/usr/lib64/libpyside2.cpython-38-x86_64-linux-gnu.so.5.13.2
/usr/lib64/libshiboken2.cpython-38-x86_64-linux-gnu.so.5.13
/usr/lib64/libshiboken2.cpython-38-x86_64-linux-gnu.so.5.13.2
